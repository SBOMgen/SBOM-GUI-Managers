...
import githubLogo from "../../public/github-purple.png";
   ...
   <div className="relative pt-36 ml-auto">
    <div className="lg:w-2/3 text-center mx-auto">
     ...
     <p className="mt-8 text-gray-700 ">
      A “software bill of materials” (SBOM) has emerged as a key building block
      in software security and software supply chain risk management. An SBOM is
      a nested inventory, a list of ingredients that make up software
      components. While not a brand new concept, the ideas and implementation
      have advanced since 2018 through a number of collaborative community
      effort, including National Telecommunications and Information
      Administration’s (NTIA) multistakeholder process.
     </p>
     ...
     <div className="hidden py-8 mt-16 border-y border-gray-100 sm:flex justify-between">
      ...
      <div className="text-left">
       <h6 className="text-lg font-semibold text-gray-700 "></h6>
       <p className="mt-2 text-gray-500">meow meow</p>
      </div>
     </div>
    </div>
