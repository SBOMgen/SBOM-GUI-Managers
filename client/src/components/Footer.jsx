            ...
            className=" border-t border-gray-100 flex m-auto  mt-32 w-2/3 justify-center items-center  text-center text-surface">
                <div className="mb-6 pt-10 flex justify-center space-x-2">
                    <a
                        ...
                        target="_blank"
                        type="button"
                        className="rounded-full bg-transparent p-3 transition duration-150 ease-in-out hover:bg-neutral-100 focus:outline-none focus:ring-0"
                        >
                        <span className="flex mx-auto [&>svg]:h-5 [&>svg]:w-5 gap-2">
                            <svg
